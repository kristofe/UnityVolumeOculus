...
{	
	...
	void UpdateCameras()
	{
		...
		OVRCamera.OrientationOffset 	= OrientationOffset;
		OVRCamera.YRotation 			= YRotation;
		
		// Values that tell the stereo cameras how to influence OVRCameraController
		OVRCamera.SetParentYRotation 	= TrackerRotatesY;
